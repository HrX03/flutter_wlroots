    ...
    case pointerKindMouse: {
      switch (message.event_type) {
        case pointerDownEvent:
          ...
          //wlr_seat_keyboard_send_key(instance->seat, message.timestamp / NS_PER_MS, 38, WL_KEYBOARD_KEY_STATE_PRESSED);
        ...
        case pointerUpEvent:
          ...
          /* wlr_seat_set_keyboard(instance->seat, wlr_seat_get_keyboard(instance->seat));
          wlr_seat_keyboard_notify_key(instance->seat, message.timestamp / NS_PER_MS,
				      38, WL_KEYBOARD_KEY_STATE_RELEASED); */
          //wlr_seat_keyboard_send_key(instance->seat, message.timestamp / NS_PER_MS, 38, WL_KEYBOARD_KEY_STATE_RELEASED);
          break;
